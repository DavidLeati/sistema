# proposal_system/external_apis/cnpj_api.py
import requests
import re
...
def consultar_cnpj(cnpj: str) -> dict:
    ...
    cnpj_limpo = re.sub(r'[^0-9]', '', cnpj) # Renomeada variável para clareza
    endpoint = f"https://open.cnpja.com/office/{cnpj_limpo}" #
